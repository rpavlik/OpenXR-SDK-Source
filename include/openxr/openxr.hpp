...
enum class CompositionLayerFlagBits :  XrFlags64 {
     CorrectChromaticAberrationBit = XR_COMPOSITION_LAYER_CORRECT_CHROMATIC_ABERRATION_BIT,
     BlendTextureSourceAlphaBit = XR_COMPOSITION_LAYER_BLEND_TEXTURE_SOURCE_ALPHA_BIT,
...
enum class InputSourceLocalizedNameFlagBits :  XrFlags64 {
     ...
     InteractionProfileBit = XR_INPUT_SOURCE_LOCALIZED_NAME_INTERACTION_PROFILE_BIT,
...
enum class DebugUtilsMessageSeverityFlagBitsEXT :  XrFlags64 {
     XrDebugUtilsMessageSeverityVerboseBit = XR_DEBUG_UTILS_MESSAGE_SEVERITY_VERBOSE_BIT_EXT,
     XrDebugUtilsMessageSeverityInfoBit = XR_DEBUG_UTILS_MESSAGE_SEVERITY_INFO_BIT_EXT,
     XrDebugUtilsMessageSeverityWarningBit = XR_DEBUG_UTILS_MESSAGE_SEVERITY_WARNING_BIT_EXT,
     XrDebugUtilsMessageSeverityErrorBit = XR_DEBUG_UTILS_MESSAGE_SEVERITY_ERROR_BIT_EXT
};
...
enum class DebugUtilsMessageTypeFlagBitsEXT :  XrFlags64 {
     XrDebugUtilsMessageTypeGeneralBit = XR_DEBUG_UTILS_MESSAGE_TYPE_GENERAL_BIT_EXT,
     XrDebugUtilsMessageTypeValidationBit = XR_DEBUG_UTILS_MESSAGE_TYPE_VALIDATION_BIT_EXT,
     XrDebugUtilsMessageTypePerformanceBit = XR_DEBUG_UTILS_MESSAGE_TYPE_PERFORMANCE_BIT_EXT,
     XrDebugUtilsMessageTypeConformanceBit = XR_DEBUG_UTILS_MESSAGE_TYPE_CONFORMANCE_BIT_EXT
};
