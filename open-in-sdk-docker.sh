...
# This image/tag is generated from https://github.com/KhronosGroup/DockerContainers/blob/master/Dockerfile.openxr-sdk
# Purpose: Build tests of loader, layers, etc.
IMAGE_NAME=khronosgroup/docker-images:openxr-sdk
MOUNTPOINT=$(pwd)
