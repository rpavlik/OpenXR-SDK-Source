...
public:
    ...
    OPENXR_HPP_CONSTEXPR explicit Duration(XrDuration t)
        : val_(t)
    {
    }
...
public:
    ...
    OPENXR_HPP_CONSTEXPR explicit Time(XrTime t)
        : val_(t)
    {
    }
...
public:
    ...
    OPENXR_HPP_TYPESAFE_EXPLICIT Instance(RawHandleType handle)
        : m_raw(handle)
    {
    }
    ...
    //! @brief xrEnumerateViewConfigurationViews wrapper - enhanced mode, stateful allocator for two-call result.
    //!
    //! See the related specification text at <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrEnumerateViewConfigurationViews>
    ...
    //! @brief xrPathToString wrapper - enhanced mode, stateful allocator for two-call result.
    //!
    //! See the related specification text at <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrPathToString>
    ...
    //! @brief xrGetVulkanInstanceExtensionsKHR wrapper - enhanced mode, stateful allocator for two-call result.
    //!
    //! See the related specification text at <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetVulkanInstanceExtensionsKHR>
    //!
    //! @note No default dispatch is provided as this is a non-core function,
    ...
    //! @brief xrGetVulkanDeviceExtensionsKHR wrapper - enhanced mode, stateful allocator for two-call result.
    //!
    //! See the related specification text at <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetVulkanDeviceExtensionsKHR>
    //!
    //! @note No default dispatch is provided as this is a non-core function,
...
//! @relates Instance
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(Instance const& lhs, Instance const& rhs) { return lhs.get() < rhs.get(); }
//! @brief < comparison between Instance and raw XrInstance.
//! @relates Instance
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(Instance const& lhs, XrInstance rhs) { return lhs.get() < rhs; }
//! @brief < comparison between raw XrInstance and Instance.
//! @relates Instance
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(XrInstance lhs, Instance const& rhs) { return lhs < rhs.get(); }
//! @brief > comparison between Instance.
//! @relates Instance
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator>(Instance const& lhs, Instance const& rhs) { return lhs.get() > rhs.get(); }
//! @brief > comparison between Instance and raw XrInstance.
...
//! @relates Instance
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(Instance const& lhs, std::nullptr_t /* unused */) { return lhs.get() == XR_NULL_HANDLE; }
//! @brief Equality comparison between nullptr and Instance: true if the handle is null.
//! @relates Instance
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(std::nullptr_t /* unused */, Instance const& rhs) { return rhs.get() == XR_NULL_HANDLE; }
...
//! @relates Instance
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE XrInstance get(Instance const& h) { return h.get(); }

//! @brief Free "put" function for clearing and getting the address of the raw XrInstance handle in a Instance (by reference).
//!
//! e.g.
//! ```
//! Instance yourHandle;
...
//! @brief Free "put" function for clearing and getting the address of the raw XrInstance handle in a Instance (by pointer).
//!
//! e.g.
//! ```
...
public:
    ...
    //!
    //! Explicit on 32-bit platforms by default unless OPENXR_HPP_TYPESAFE_CONVERSION is defined.
    OPENXR_HPP_TYPESAFE_EXPLICIT Session(RawHandleType handle)
        : m_raw(handle)
    {
    }
    ...
    //! @brief xrEnumerateReferenceSpaces wrapper - enhanced mode, stateful allocator for two-call result.
    //!
    //! See the related specification text at <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrEnumerateReferenceSpaces>
    ...
    //! @brief xrEnumerateSwapchainFormats wrapper - enhanced mode, stateful allocator for two-call result.
    //!
    //! See the related specification text at <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrEnumerateSwapchainFormats>
...
//! @relates Session
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(Session const& lhs, Session const& rhs) { return lhs.get() < rhs.get(); }
//! @brief < comparison between Session and raw XrSession.
//! @relates Session
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(Session const& lhs, XrSession rhs) { return lhs.get() < rhs; }
//! @brief < comparison between raw XrSession and Session.
//! @relates Session
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(XrSession lhs, Session const& rhs) { return lhs < rhs.get(); }
//! @brief > comparison between Session.
//! @relates Session
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator>(Session const& lhs, Session const& rhs) { return lhs.get() > rhs.get(); }
//! @brief > comparison between Session and raw XrSession.
...
//! @relates Session
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(Session const& lhs, std::nullptr_t /* unused */) { return lhs.get() == XR_NULL_HANDLE; }
//! @brief Equality comparison between nullptr and Session: true if the handle is null.
//! @relates Session
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(std::nullptr_t /* unused */, Session const& rhs) { return rhs.get() == XR_NULL_HANDLE; }
...
//! @relates Session
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE XrSession get(Session const& h) { return h.get(); }

//! @brief Free "put" function for clearing and getting the address of the raw XrSession handle in a Session (by reference).
//!
//! e.g.
//! ```
//! Session yourHandle;
...
//! @brief Free "put" function for clearing and getting the address of the raw XrSession handle in a Session (by pointer).
//!
//! e.g.
//! ```
...
public:
    ...
    //!
    //! Explicit on 32-bit platforms by default unless OPENXR_HPP_TYPESAFE_CONVERSION is defined.
    OPENXR_HPP_TYPESAFE_EXPLICIT Space(RawHandleType handle)
        : m_raw(handle)
    {
    }
...
//! @relates Space
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(Space const& lhs, Space const& rhs) { return lhs.get() < rhs.get(); }
//! @brief < comparison between Space and raw XrSpace.
//! @relates Space
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(Space const& lhs, XrSpace rhs) { return lhs.get() < rhs; }
//! @brief < comparison between raw XrSpace and Space.
//! @relates Space
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(XrSpace lhs, Space const& rhs) { return lhs < rhs.get(); }
//! @brief > comparison between Space.
//! @relates Space
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator>(Space const& lhs, Space const& rhs) { return lhs.get() > rhs.get(); }
//! @brief > comparison between Space and raw XrSpace.
...
//! @relates Space
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(Space const& lhs, std::nullptr_t /* unused */) { return lhs.get() == XR_NULL_HANDLE; }
//! @brief Equality comparison between nullptr and Space: true if the handle is null.
//! @relates Space
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(std::nullptr_t /* unused */, Space const& rhs) { return rhs.get() == XR_NULL_HANDLE; }
...
//! @relates Space
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE XrSpace get(Space const& h) { return h.get(); }

//! @brief Free "put" function for clearing and getting the address of the raw XrSpace handle in a Space (by reference).
//!
//! e.g.
//! ```
//! Space yourHandle;
...
//! @brief Free "put" function for clearing and getting the address of the raw XrSpace handle in a Space (by pointer).
//!
//! e.g.
//! ```
...
public:
    ...
    //!
    //! Explicit on 32-bit platforms by default unless OPENXR_HPP_TYPESAFE_CONVERSION is defined.
    OPENXR_HPP_TYPESAFE_EXPLICIT Action(RawHandleType handle)
        : m_raw(handle)
    {
    }
...
//! @relates Action
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(Action const& lhs, Action const& rhs) { return lhs.get() < rhs.get(); }
//! @brief < comparison between Action and raw XrAction.
//! @relates Action
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(Action const& lhs, XrAction rhs) { return lhs.get() < rhs; }
//! @brief < comparison between raw XrAction and Action.
//! @relates Action
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(XrAction lhs, Action const& rhs) { return lhs < rhs.get(); }
//! @brief > comparison between Action.
//! @relates Action
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator>(Action const& lhs, Action const& rhs) { return lhs.get() > rhs.get(); }
//! @brief > comparison between Action and raw XrAction.
...
//! @relates Action
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(Action const& lhs, std::nullptr_t /* unused */) { return lhs.get() == XR_NULL_HANDLE; }
//! @brief Equality comparison between nullptr and Action: true if the handle is null.
//! @relates Action
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(std::nullptr_t /* unused */, Action const& rhs) { return rhs.get() == XR_NULL_HANDLE; }
...
//! @relates Action
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE XrAction get(Action const& h) { return h.get(); }

//! @brief Free "put" function for clearing and getting the address of the raw XrAction handle in a Action (by reference).
//!
//! e.g.
//! ```
//! Action yourHandle;
...
//! @brief Free "put" function for clearing and getting the address of the raw XrAction handle in a Action (by pointer).
//!
//! e.g.
//! ```
...
public:
     ...
     */
    //! Default (empty/null) constructor
    OPENXR_HPP_CONSTEXPR Swapchain()
        : m_raw(XR_NULL_HANDLE)
    {
    }
    ...
    //! @brief xrEnumerateSwapchainImages wrapper - enhanced mode, stateful allocator for two-call result.
    //!
    //! See the related specification text at <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrEnumerateSwapchainImages>
...
//! @relates Swapchain
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(Swapchain const& lhs, Swapchain const& rhs) { return lhs.get() < rhs.get(); }
//! @brief < comparison between Swapchain and raw XrSwapchain.
//! @relates Swapchain
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(Swapchain const& lhs, XrSwapchain rhs) { return lhs.get() < rhs; }
//! @brief < comparison between raw XrSwapchain and Swapchain.
//! @relates Swapchain
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(XrSwapchain lhs, Swapchain const& rhs) { return lhs < rhs.get(); }
//! @brief > comparison between Swapchain.
//! @relates Swapchain
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator>(Swapchain const& lhs, Swapchain const& rhs) { return lhs.get() > rhs.get(); }
//! @brief > comparison between Swapchain and raw XrSwapchain.
...
//! @relates Swapchain
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(Swapchain const& lhs, std::nullptr_t /* unused */) { return lhs.get() == XR_NULL_HANDLE; }
//! @brief Equality comparison between nullptr and Swapchain: true if the handle is null.
//! @relates Swapchain
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(std::nullptr_t /* unused */, Swapchain const& rhs) { return rhs.get() == XR_NULL_HANDLE; }
...
//! @relates Swapchain
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE XrSwapchain get(Swapchain const& h) { return h.get(); }

//! @brief Free "put" function for clearing and getting the address of the raw XrSwapchain handle in a Swapchain (by reference).
//!
//! e.g.
//! ```
//! Swapchain yourHandle;
...
//! @brief Free "put" function for clearing and getting the address of the raw XrSwapchain handle in a Swapchain (by pointer).
//!
//! e.g.
//! ```
...
public:
     ...
     */
    //! Default (empty/null) constructor
    OPENXR_HPP_CONSTEXPR ActionSet()
        : m_raw(XR_NULL_HANDLE)
    {
    }
...
//! @relates ActionSet
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(ActionSet const& lhs, ActionSet const& rhs) { return lhs.get() < rhs.get(); }
//! @brief < comparison between ActionSet and raw XrActionSet.
//! @relates ActionSet
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(ActionSet const& lhs, XrActionSet rhs) { return lhs.get() < rhs; }
//! @brief < comparison between raw XrActionSet and ActionSet.
//! @relates ActionSet
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(XrActionSet lhs, ActionSet const& rhs) { return lhs < rhs.get(); }
//! @brief > comparison between ActionSet.
//! @relates ActionSet
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator>(ActionSet const& lhs, ActionSet const& rhs) { return lhs.get() > rhs.get(); }
//! @brief > comparison between ActionSet and raw XrActionSet.
...
//! @relates ActionSet
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(ActionSet const& lhs, std::nullptr_t /* unused */) { return lhs.get() == XR_NULL_HANDLE; }
//! @brief Equality comparison between nullptr and ActionSet: true if the handle is null.
//! @relates ActionSet
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(std::nullptr_t /* unused */, ActionSet const& rhs) { return rhs.get() == XR_NULL_HANDLE; }
...
//! @relates ActionSet
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE XrActionSet get(ActionSet const& h) { return h.get(); }

//! @brief Free "put" function for clearing and getting the address of the raw XrActionSet handle in a ActionSet (by reference).
//!
//! e.g.
//! ```
//! ActionSet yourHandle;
...
//! @brief Free "put" function for clearing and getting the address of the raw XrActionSet handle in a ActionSet (by pointer).
//!
//! e.g.
//! ```
...
public:
     ...
     */
    //! Default (empty/null) constructor
    OPENXR_HPP_CONSTEXPR DebugUtilsMessengerEXT()
        : m_raw(XR_NULL_HANDLE)
    {
    }
...
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(DebugUtilsMessengerEXT const& lhs, DebugUtilsMessengerEXT const& rhs) { return lhs.get() < rhs.get(); }
//! @brief < comparison between DebugUtilsMessengerEXT and raw XrDebugUtilsMessengerEXT.
//! @relates DebugUtilsMessengerEXT
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(DebugUtilsMessengerEXT const& lhs, XrDebugUtilsMessengerEXT rhs) { return lhs.get() < rhs; }
//! @brief < comparison between raw XrDebugUtilsMessengerEXT and DebugUtilsMessengerEXT.
//! @relates DebugUtilsMessengerEXT
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(XrDebugUtilsMessengerEXT lhs, DebugUtilsMessengerEXT const& rhs) { return lhs < rhs.get(); }
//! @brief > comparison between DebugUtilsMessengerEXT.
//! @relates DebugUtilsMessengerEXT
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator>(DebugUtilsMessengerEXT const& lhs, DebugUtilsMessengerEXT const& rhs) { return lhs.get() > rhs.get(); }
//! @brief > comparison between DebugUtilsMessengerEXT and raw XrDebugUtilsMessengerEXT.
...
//! @relates DebugUtilsMessengerEXT
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(DebugUtilsMessengerEXT const& lhs, std::nullptr_t /* unused */) { return lhs.get() == XR_NULL_HANDLE; }
//! @brief Equality comparison between nullptr and DebugUtilsMessengerEXT: true if the handle is null.
//! @relates DebugUtilsMessengerEXT
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(std::nullptr_t /* unused */, DebugUtilsMessengerEXT const& rhs) { return rhs.get() == XR_NULL_HANDLE; }
...
//! @brief Free function accessor for the raw XrDebugUtilsMessengerEXT handle in a DebugUtilsMessengerEXT
//! @relates DebugUtilsMessengerEXT
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE XrDebugUtilsMessengerEXT get(DebugUtilsMessengerEXT const& h) { return h.get(); }

//! @brief Free "put" function for clearing and getting the address of the raw XrDebugUtilsMessengerEXT handle in a DebugUtilsMessengerEXT (by reference).
//!
//! e.g.
//! ```
//! DebugUtilsMessengerEXT yourHandle;
...
//! Should be found by argument-dependent lookup and thus not need to have the namespace specified.
//! @relates DebugUtilsMessengerEXT
OPENXR_HPP_INLINE XrDebugUtilsMessengerEXT* put(DebugUtilsMessengerEXT& h) { return h.put(); }

//! @brief Free "put" function for clearing and getting the address of the raw XrDebugUtilsMessengerEXT handle in a DebugUtilsMessengerEXT (by pointer).
//!
//! e.g.
//! ```
...
public:
     ...
     */
    //! Default (empty/null) constructor
    OPENXR_HPP_CONSTEXPR SpatialAnchorMSFT()
        : m_raw(XR_NULL_HANDLE)
    {
    }
...
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(SpatialAnchorMSFT const& lhs, SpatialAnchorMSFT const& rhs) { return lhs.get() < rhs.get(); }
//! @brief < comparison between SpatialAnchorMSFT and raw XrSpatialAnchorMSFT.
//! @relates SpatialAnchorMSFT
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(SpatialAnchorMSFT const& lhs, XrSpatialAnchorMSFT rhs) { return lhs.get() < rhs; }
//! @brief < comparison between raw XrSpatialAnchorMSFT and SpatialAnchorMSFT.
//! @relates SpatialAnchorMSFT
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(XrSpatialAnchorMSFT lhs, SpatialAnchorMSFT const& rhs) { return lhs < rhs.get(); }
//! @brief > comparison between SpatialAnchorMSFT.
//! @relates SpatialAnchorMSFT
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator>(SpatialAnchorMSFT const& lhs, SpatialAnchorMSFT const& rhs) { return lhs.get() > rhs.get(); }
//! @brief > comparison between SpatialAnchorMSFT and raw XrSpatialAnchorMSFT.
...
//! @relates SpatialAnchorMSFT
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(SpatialAnchorMSFT const& lhs, std::nullptr_t /* unused */) { return lhs.get() == XR_NULL_HANDLE; }
//! @brief Equality comparison between nullptr and SpatialAnchorMSFT: true if the handle is null.
//! @relates SpatialAnchorMSFT
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(std::nullptr_t /* unused */, SpatialAnchorMSFT const& rhs) { return rhs.get() == XR_NULL_HANDLE; }
...
//! @brief Free function accessor for the raw XrSpatialAnchorMSFT handle in a SpatialAnchorMSFT
//! @relates SpatialAnchorMSFT
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE XrSpatialAnchorMSFT get(SpatialAnchorMSFT const& h) { return h.get(); }

//! @brief Free "put" function for clearing and getting the address of the raw XrSpatialAnchorMSFT handle in a SpatialAnchorMSFT (by reference).
//!
//! e.g.
//! ```
//! SpatialAnchorMSFT yourHandle;
...
//! Should be found by argument-dependent lookup and thus not need to have the namespace specified.
//! @relates SpatialAnchorMSFT
OPENXR_HPP_INLINE XrSpatialAnchorMSFT* put(SpatialAnchorMSFT& h) { return h.put(); }

//! @brief Free "put" function for clearing and getting the address of the raw XrSpatialAnchorMSFT handle in a SpatialAnchorMSFT (by pointer).
//!
//! e.g.
//! ```
...
//! @brief xrEnumerateApiLayerProperties wrapper - enhanced mode, stateful allocator for two-call result.
//!
//! See the related specification text at <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrEnumerateApiLayerProperties>
...
//! @brief xrEnumerateInstanceExtensionProperties wrapper - enhanced mode, stateful allocator for two-call result.
//!
//! See the related specification text at <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrEnumerateInstanceExtensionProperties>
...
struct CompositionLayerProjection : public traits::TypedStructTraits<CompositionLayerProjection> {
private:
...
struct CompositionLayerQuad : public traits::TypedStructTraits<CompositionLayerQuad> {
private:
...
struct EventDataEventsLost : public traits::TypedStructTraits<EventDataEventsLost> {
private:
...
struct EventDataInstanceLossPending : public traits::TypedStructTraits<EventDataInstanceLossPending> {
private:
...
struct EventDataSessionStateChanged : public traits::TypedStructTraits<EventDataSessionStateChanged> {
private:
...
struct EventDataReferenceSpaceChangePending : public traits::TypedStructTraits<EventDataReferenceSpaceChangePending> {
private:
    using Parent = traits::TypedStructTraits<EventDataReferenceSpaceChangePending>;
...
struct EventDataInteractionProfileChanged : public traits::TypedStructTraits<EventDataInteractionProfileChanged> {
private:
...
struct CompositionLayerCubeKHR : public traits::TypedStructTraits<CompositionLayerCubeKHR> {
private:
...
struct CompositionLayerCylinderKHR : public traits::TypedStructTraits<CompositionLayerCylinderKHR> {
private:
...
struct CompositionLayerEquirectKHR : public traits::TypedStructTraits<CompositionLayerEquirectKHR> {
private:
...
#if defined(XR_USE_GRAPHICS_API_OPENGL)
struct SwapchainImageOpenGLKHR : public traits::TypedStructTraits<SwapchainImageOpenGLKHR> {
private:
...
#if defined(XR_USE_GRAPHICS_API_OPENGL_ES)
struct SwapchainImageOpenGLESKHR : public traits::TypedStructTraits<SwapchainImageOpenGLESKHR> {
private:
...
#if defined(XR_USE_GRAPHICS_API_VULKAN)
struct SwapchainImageVulkanKHR : public traits::TypedStructTraits<SwapchainImageVulkanKHR> {
private:
...
#if defined(XR_USE_GRAPHICS_API_D3D11)
struct SwapchainImageD3D11KHR : public traits::TypedStructTraits<SwapchainImageD3D11KHR> {
private:
...
#if defined(XR_USE_GRAPHICS_API_D3D12)
struct SwapchainImageD3D12KHR : public traits::TypedStructTraits<SwapchainImageD3D12KHR> {
private:
...
struct EventDataVisibilityMaskChangedKHR : public traits::TypedStructTraits<EventDataVisibilityMaskChangedKHR> {
private:
...
struct EventDataPerfSettingsEXT : public traits::TypedStructTraits<EventDataPerfSettingsEXT> {
private:
    ...
    Dispatch&& d) const
{
    ...
    Result result = static_cast<Result>(d.xrGetInstanceProperties(this->get(), OPENXR_HPP_NAMESPACE::put(structResult)));
...
{
    Result result = static_cast<Result>(d.xrGetSystem(this->get(), OPENXR_HPP_NAMESPACE::get(getInfo), systemId));
    return result;
}
#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
    ...
    const SystemGetInfo& getInfo, Dispatch&& d) const
{
    ...
    Result result = static_cast<Result>(d.xrGetSystem(this->get(), OPENXR_HPP_NAMESPACE::get(getInfo), &structResult));
...
{
    Result result = static_cast<Result>(d.xrGetSystemProperties(this->get(), systemId, OPENXR_HPP_NAMESPACE::put(properties)));
    return result;
}
#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
    ...
    XrSystemId systemId, Dispatch&& d) const
{
    ...
    Result result = static_cast<Result>(d.xrGetSystemProperties(this->get(), systemId, OPENXR_HPP_NAMESPACE::put(structResult)));
    ...
    Space baseSpace, const Time& time, Dispatch&& d) const
{
    ...
    Result result = static_cast<Result>(d.xrLocateSpace(this->get(), baseSpace.get(), OPENXR_HPP_NAMESPACE::get(time), OPENXR_HPP_NAMESPACE::put(structResult)));
...
{
    Result result = static_cast<Result>(d.xrGetViewConfigurationProperties(this->get(), systemId, OPENXR_HPP_NAMESPACE::get(viewConfigurationType), OPENXR_HPP_NAMESPACE::put(configurationProperties)));
    return result;
}
#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
    ...
    XrSystemId systemId, ViewConfigurationType viewConfigurationType, Dispatch&& d) const
{
    ...
    Result result = static_cast<Result>(d.xrGetViewConfigurationProperties(this->get(), systemId, OPENXR_HPP_NAMESPACE::get(viewConfigurationType), OPENXR_HPP_NAMESPACE::put(structResult)));
    ...
    XrSystemId systemId, ViewConfigurationType viewConfigurationType, Dispatch&& d) const
{
    ...
    do {
        ...
        result = static_cast<Result>(d.xrEnumerateViewConfigurationViews(this->get(), systemId, OPENXR_HPP_NAMESPACE::get(viewConfigurationType), viewCapacityInput, &viewCountOutput, reinterpret_cast<XrViewConfigurationView*>(views.data())));
    } while (result == xr::Result::ErrorSizeInsufficient);
    if (result == xr::Result::Success) {
    ...
    const SwapchainImageAcquireInfo& acquireInfo, Dispatch&& d) const
{
    ...
    Result result = static_cast<Result>(d.xrAcquireSwapchainImage(this->get(), OPENXR_HPP_NAMESPACE::get(acquireInfo), &structResult));
    ...
    const FrameWaitInfo& frameWaitInfo, Dispatch&& d) const
{
    ...
    Result result = static_cast<Result>(d.xrWaitFrame(this->get(), OPENXR_HPP_NAMESPACE::get(frameWaitInfo), OPENXR_HPP_NAMESPACE::put(structResult)));
    ...
    XrPath path, Dispatch&& d) const
{
    ...
    do {
        ...
        result = static_cast<Result>(d.xrPathToString(this->get(), path, bufferCapacityInput, &bufferCountOutput, reinterpret_cast<char*>(buffer.data())));
    } while (result == xr::Result::ErrorSizeInsufficient);
    if (result == xr::Result::Success) {
...
{
    Result result = static_cast<Result>(d.xrGetCurrentInteractionProfile(this->get(), topLevelUserPath, OPENXR_HPP_NAMESPACE::put(interactionProfile)));
    return result;
}
#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
    ...
    XrPath topLevelUserPath, Dispatch&& d) const
{
    ...
    Result result = static_cast<Result>(d.xrGetCurrentInteractionProfile(this->get(), topLevelUserPath, OPENXR_HPP_NAMESPACE::put(structResult)));
    ...
    const ActionStateGetInfo& getInfo, Dispatch&& d) const
{
    ...
    Result result = static_cast<Result>(d.xrGetActionStateBoolean(this->get(), OPENXR_HPP_NAMESPACE::get(getInfo), OPENXR_HPP_NAMESPACE::put(structResult)));
    ...
    const ActionStateGetInfo& getInfo, Dispatch&& d) const
{
    ...
    Result result = static_cast<Result>(d.xrGetActionStateFloat(this->get(), OPENXR_HPP_NAMESPACE::get(getInfo), OPENXR_HPP_NAMESPACE::put(structResult)));
    ...
    const ActionStateGetInfo& getInfo, Dispatch&& d) const
{
    ...
    Result result = static_cast<Result>(d.xrGetActionStateVector2f(this->get(), OPENXR_HPP_NAMESPACE::get(getInfo), OPENXR_HPP_NAMESPACE::put(structResult)));
    ...
    const ActionStateGetInfo& getInfo, Dispatch&& d) const
{
    ...
    Result result = static_cast<Result>(d.xrGetActionStatePose(this->get(), OPENXR_HPP_NAMESPACE::get(getInfo), OPENXR_HPP_NAMESPACE::put(structResult)));
...
{
    Result result = static_cast<Result>(d.xrEnumerateBoundSourcesForAction(this->get(), OPENXR_HPP_NAMESPACE::get(enumerateInfo), sourceCapacityInput, sourceCountOutput, sources));
    return result;
}
#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
template <typename Allocator, typename Dispatch>
...
OPENXR_HPP_INLINE Result Instance::getOpenGLGraphicsRequirementsKHR(
    XrSystemId systemId, GraphicsRequirementsOpenGLKHR& graphicsRequirements, Dispatch&& d) const
{
    Result result = static_cast<Result>(d.xrGetOpenGLGraphicsRequirementsKHR(this->get(), systemId, OPENXR_HPP_NAMESPACE::put(graphicsRequirements)));
    return result;
}
#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
    ...
    XrSystemId systemId, Dispatch&& d) const
{
    ...
    Result result = static_cast<Result>(d.xrGetOpenGLGraphicsRequirementsKHR(this->get(), systemId, OPENXR_HPP_NAMESPACE::put(structResult)));
...
OPENXR_HPP_INLINE Result Instance::getOpenGLESGraphicsRequirementsKHR(
    XrSystemId systemId, GraphicsRequirementsOpenGLESKHR& graphicsRequirements, Dispatch&& d) const
{
    Result result = static_cast<Result>(d.xrGetOpenGLESGraphicsRequirementsKHR(this->get(), systemId, OPENXR_HPP_NAMESPACE::put(graphicsRequirements)));
    return result;
}
#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
    ...
    XrSystemId systemId, Dispatch&& d) const
{
    ...
    Result result = static_cast<Result>(d.xrGetOpenGLESGraphicsRequirementsKHR(this->get(), systemId, OPENXR_HPP_NAMESPACE::put(structResult)));
    ...
    XrSystemId systemId, Dispatch&& d) const
{
    ...
    do {
        buffer.resize(bufferCountOutput);
        bufferCapacityInput = static_cast<uint32_t>(buffer.size());
        result = static_cast<Result>(d.xrGetVulkanInstanceExtensionsKHR(this->get(), systemId, bufferCapacityInput, &bufferCountOutput, reinterpret_cast<char*>(buffer.data())));
    } while (result == xr::Result::ErrorSizeInsufficient);
    if (result == xr::Result::Success) {
        OPENXR_HPP_ASSERT(bufferCountOutput <= buffer.size());
        buffer.resize(bufferCountOutput);
    ...
    XrSystemId systemId, Dispatch&& d) const
{
    ...
    do {
        buffer.resize(bufferCountOutput);
        bufferCapacityInput = static_cast<uint32_t>(buffer.size());
        result = static_cast<Result>(d.xrGetVulkanDeviceExtensionsKHR(this->get(), systemId, bufferCapacityInput, &bufferCountOutput, reinterpret_cast<char*>(buffer.data())));
    } while (result == xr::Result::ErrorSizeInsufficient);
    if (result == xr::Result::Success) {
        OPENXR_HPP_ASSERT(bufferCountOutput <= buffer.size());
        buffer.resize(bufferCountOutput);
    ...
    XrSystemId systemId, VkInstance vkInstance, Dispatch&& d) const
{
    ...
    Result result = static_cast<Result>(d.xrGetVulkanGraphicsDeviceKHR(this->get(), systemId, vkInstance, &structResult));
...
OPENXR_HPP_INLINE Result Instance::getVulkanGraphicsRequirementsKHR(
    XrSystemId systemId, GraphicsRequirementsVulkanKHR& graphicsRequirements, Dispatch&& d) const
{
    Result result = static_cast<Result>(d.xrGetVulkanGraphicsRequirementsKHR(this->get(), systemId, OPENXR_HPP_NAMESPACE::put(graphicsRequirements)));
    return result;
}
#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
    ...
    XrSystemId systemId, Dispatch&& d) const
{
    ...
    Result result = static_cast<Result>(d.xrGetVulkanGraphicsRequirementsKHR(this->get(), systemId, OPENXR_HPP_NAMESPACE::put(structResult)));
...
OPENXR_HPP_INLINE Result Instance::getD3D11GraphicsRequirementsKHR(
    XrSystemId systemId, GraphicsRequirementsD3D11KHR& graphicsRequirements, Dispatch&& d) const
{
    Result result = static_cast<Result>(d.xrGetD3D11GraphicsRequirementsKHR(this->get(), systemId, OPENXR_HPP_NAMESPACE::put(graphicsRequirements)));
    return result;
}
#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
    ...
    XrSystemId systemId, Dispatch&& d) const
{
    ...
    Result result = static_cast<Result>(d.xrGetD3D11GraphicsRequirementsKHR(this->get(), systemId, OPENXR_HPP_NAMESPACE::put(structResult)));
...
OPENXR_HPP_INLINE Result Instance::getD3D12GraphicsRequirementsKHR(
    XrSystemId systemId, GraphicsRequirementsD3D12KHR& graphicsRequirements, Dispatch&& d) const
{
    Result result = static_cast<Result>(d.xrGetD3D12GraphicsRequirementsKHR(this->get(), systemId, OPENXR_HPP_NAMESPACE::put(graphicsRequirements)));
    return result;
}
#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
    ...
    XrSystemId systemId, Dispatch&& d) const
{
    ...
    Result result = static_cast<Result>(d.xrGetD3D12GraphicsRequirementsKHR(this->get(), systemId, OPENXR_HPP_NAMESPACE::put(structResult)));
    ...
    ViewConfigurationType viewConfigurationType, uint32_t viewIndex, VisibilityMaskTypeKHR visibilityMaskType, Dispatch&& d) const
{
    ...
    Result result = static_cast<Result>(d.xrGetVisibilityMaskKHR(this->get(), OPENXR_HPP_NAMESPACE::get(viewConfigurationType), viewIndex, OPENXR_HPP_NAMESPACE::get(visibilityMaskType), OPENXR_HPP_NAMESPACE::put(structResult)));
    ...
    const Time& time, Dispatch&& d) const
{
    ...
    Result result = static_cast<Result>(d.xrConvertTimeToWin32PerformanceCounterKHR(this->get(), OPENXR_HPP_NAMESPACE::get(time), &structResult));
    ...
    const Time& time, Dispatch&& d) const
{
    ...
    Result result = static_cast<Result>(d.xrConvertTimeToTimespecTimeKHR(this->get(), OPENXR_HPP_NAMESPACE::get(time), &structResult));
